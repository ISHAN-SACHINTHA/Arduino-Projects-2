 ...
 */
  ...
  const int _delay = 200; //delay for letters
  ...
  char textString[] = "123456789" ;
  char textString1[] = "Ishan Sachintha";
  char textString2[] = "Danthanarayana";
  char textString3[] = "Ishan Sachintha";
